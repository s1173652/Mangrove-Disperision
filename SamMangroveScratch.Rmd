...
pairwise.wilcox.test(Daneshgar_Mangrove_Data_Cleaned$`Distance traveled.m`, Daneshgar_Mangrove_Data_Cleaned$Zone, p.adjust.method = "bonferroni", paired = FALSE)
```
...
```{r}
SignTest(Daneshgar_Mangrove_Data_Cleaned$`Distance traveled.m`, Daneshgar_Mangrove_Data_Cleaned$Zone, mu=0,alternative="two.sided", conf.level = 0.95)
```

```{r}
SignTest(Daneshgar_Mangrove_Data_Cleaned$`Distance traveled.m`, Daneshgar_Mangrove_Data_Cleaned$`DensityCode`, mu=0,alternative="two.sided", conf.level = 0.95)
```
```{r}
SignTest(Daneshgar_Mangrove_Data_Cleaned$`Distance traveled.m`, Daneshgar_Mangrove_Data_Cleaned$Tide, mu=0,alternative="two.sided", conf.level = 0.95)
```
